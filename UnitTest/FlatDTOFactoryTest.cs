...
namespace UnitTest
{
    ...
    public class FlatDTOFactoryTest
    {
        ...
        protected virtual IMapperEngine GetMappingEngine(IEnumerable<IComplexObjectDescriptor> descriptor = null)
        {
            if (descriptor != null)
                return new FlatMapperEngine(descriptor);
            else
        ...
        [TestMethod]
        [ExpectedException(typeof(FlatDTO.Exception.PropertyIsNotSimpleTypeException))]
        ...
        [TestMethod]
        public void ComplexObjectDescriptorSimpleTest()
        {
            var data = Mockup.Data.GetComplexTwoLevelMockupData();
            ...
            Assert.IsTrue(((decimal)rootType.GetProperty(propertyString[1]).GetValue(value, null)) == data[0].DecimalValue, "The decimal property was not correct");
            Assert.IsTrue(((int)rootType.GetProperty(propertyString[2]).GetValue(value, null)) == data[0].IntegerValue, "The int property was not correct");
            Assert.IsTrue(((string)rootType.GetProperty(propertyString[5]).GetValue(value, null)).Equals(descriptors.FirstOrDefault().Describe(data[0].ComplexProperty), StringComparison.InvariantCultureIgnoreCase), "The string property was not correct");
